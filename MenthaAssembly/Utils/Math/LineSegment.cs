...
namespace MenthaAssembly
{
        ...
        where T : unmanaged
    {
        ...
        /// </summary>
        /// <param name="LineSegment">The target line.</param>
        ...
        internal static bool OnSegment(T Lx1, T Ly1, T Lx2, T Ly2, T Px, T Py)
        {
            ...
            return GreaterThan(Px, MinX) && GreaterThan(MaxX, Px) &&
                   GreaterThan(Py, MinY) && GreaterThan(MaxY, Py);
        }

        /// <summary>
        /// Calculate the cross points between two lines segment.
        /// </summary>
        /// <param name="LineSegment1">The first target line.</param>
        /// <param name="LineSegment2">the second target line.</param>
        ...
        /// Calculate the cross points between two lines segment.
        /// </summary>
        /// <param name="LineSegment">The first target line.</param>
