...
{
    [Flags]
    internal enum SHFileAttributes : uint
    {
        /// <summary>
        ...
        /// Opening the item will be more expensive than normal, e.g. 
        ...
        /// For a directory it means that some of the directory contents are being virtualized from another location. Reading the file / enumerating the directory will be more expensive than normal, e.g. 
        /// it will cause at least some of the file/directory content to be fetched from a remote store. 
